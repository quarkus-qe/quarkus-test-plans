...
- all functionalities shall be tested for PostgreSQL, MariaDB, Oracle, SQL Server and DB2
...
### Impact on resources
Test execution time will increase very roughly by 1 h 5 minutes due to:

- 5 databases * 4 minutes for a JVM mode test = 20 minutes
- 5 databases * 8 minutes for a native mode test = 40 minutes
