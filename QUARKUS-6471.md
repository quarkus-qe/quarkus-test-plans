...
There is some tests upstream, but they do not include running the real OIDC provider or changing `quarkus.oidc.resource-metadata.resource` property.

### Impact on test suites and testing automation

Existing test classes in the `http-advanced` and `http-advanced` reactive modules will be enhanced with a few test methods.
...
* Tester: Fedor Dudinskiy <fdvudinsk@redhat.com>
